...
export const TARGET_WORDS: TargetWord[] = [
  ...
  { id: 'lion', text: 'lion', icon: '🦁' },
  { id: 'tiger', text: 'tiger', icon: '🐯' },
  { id: 'bear', text: 'bear', icon: '🐻' },
  { id: 'elephant', text: 'elephant', icon: '🐘' },
  { id: 'monkey', text: 'monkey', icon: '🐵' },
  { id: 'giraffe', text: 'giraffe', icon: '🦒' },
  { id: 'sheep', text: 'sheep', icon: '🐑' },
  { id: 'chicken', text: 'chicken', icon: '🐔' },
  { id: 'turtle', text: 'turtle', icon: '🐢' },
  { id: 'frog', text: 'frog', icon: '🐸' },
  { id: 'apple', text: 'apple', icon: '🍎' },
  { id: 'banana', text: 'banana', icon: '🍌' },
  { id: 'pear', text: 'pear', icon: '🍐' },
  { id: 'watermelon', text: 'watermelon', icon: '🍉' },
  { id: 'strawberry', text: 'strawberry', icon: '🍓' },
  { id: 'grapes', text: 'grapes', icon: '🍇' },
  ...
  { id: 'noodles', text: 'noodles', icon: '🍜' },
  { id: 'sandwich', text: 'sandwich', icon: '🥪' },
  { id: 'yogurt', text: 'yogurt', icon: '🥣' },
  { id: 'cereal', text: 'cereal', icon: '🥣' },
